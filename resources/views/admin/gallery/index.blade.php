        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="card-box table-responsive">
                    ...
                    @endif
                    <table class="table table-hover nowrap" id="tabel-gallery">
                        <thead align="center">
                            <th>No</th>
                            <th>Kategori</th>
                            <th>Keterangan</th>
                        ...
                        <tbody align="center">
                            @foreach ($kategories as $row)
                                <tr>
                                    ...
                                    <td>{{ $row->kategori }}</td>
                                    <td>{{ $row->keterangan == '' ? 'Kosong' : $row->keterangan }}</td>
                                    <td>
                                        <div class="btn-group" aria-pressed="true">
                                            <form action="{{ route('admin.galleries.delete', ['id' => $row->id]) }}"
                                            ...
                                            <a href="{{ route('admin.subgalleries', ['id' => $row['id']]) }}"
                ...
                <form action="{{ route('admin.galleries.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="keterangan" id="keterangan" cols="10" rows="5" class="form-control form-control-alternative"
